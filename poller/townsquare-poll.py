...
CRIER = os.environ.get("TS_CRIER_URL", "http://localhost:8787")
HOST = os.environ.get("TS_HOST_NAME") or os.uname().nodename.lower()
DIR = os.path.expanduser(os.environ.get("TS_DROP_DIR", "~/.townsquare"))
